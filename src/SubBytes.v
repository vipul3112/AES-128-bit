module SubBytes(SubBytes_out,in);
input [127:0]in;
...
S_box n1(sub0,pre_state0);
S_box n2(sub1,pre_state1);
S_box n3(sub2,pre_state2);
S_box n4(sub3,pre_state3);
S_box n5(sub4,pre_state4);
S_box n6(sub5,pre_state5);
S_box n7(sub6,pre_state6);
S_box n8(sub7,pre_state7);
S_box n9(sub8,pre_state8);
S_box n10(sub9,pre_state9);
S_box n11(sub10,pre_state10);
S_box n12(sub11,pre_state11);
S_box n13(sub12,pre_state12);
S_box n14(sub13,pre_state13);
S_box n15(sub14,pre_state14);
S_box n16(sub15,pre_state15);
